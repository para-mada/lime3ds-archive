...
ConfigureSystem::ConfigureSystem(Core::System& system_, QWidget* parent)
    ...
    if (keys_available) {
        ...
        ui->label_nus_download->setText(
            tr("LimoMada3DS is missing keys to download system files. <br><a "
...
void ConfigureSystem::DownloadFromNUS() {
    ...
    if (failed) {
        QMessageBox::critical(this, tr("LimoMada3DS"), tr("Downloading system files failed."));
    } else if (!future_watcher.isCanceled()) {
        QMessageBox::information(this, tr("LimoMada3DS"), tr("Successfully downloaded system files."));
    }
