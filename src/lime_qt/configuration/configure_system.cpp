...
ConfigureSystem::ConfigureSystem(Core::System& system_, QWidget* parent)
    ...
    if (keys_available) {
        ...
        ui->label_nus_download->setText(
            tr("MadaLime is missing keys to download system files. <br><a "
...
void ConfigureSystem::DownloadFromNUS() {
    ...
    if (failed) {
        QMessageBox::critical(this, tr("MadaLime"), tr("Downloading system files failed."));
    } else if (!future_watcher.isCanceled()) {
        QMessageBox::information(this, tr("MadaLime"), tr("Successfully downloaded system files."));
    }
